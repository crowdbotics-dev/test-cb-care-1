"""
Django settings for test_cb_care_1 project.
...
ROOT_URLCONF = 'test_cb_care_1.urls'
...
WSGI_APPLICATION = 'test_cb_care_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_cb_care_1 API",
    "DESCRIPTION": "API documentation for test_cb_care_1 App",
    "VERSION": "v1",
}
